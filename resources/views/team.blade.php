...
<body>
    ...
    <div class="team-container">
        <div class="left-grp vertical-center">
            <h1 class="team-header" style="font-weight:800;">KELOMPOK 6</h1>
            <h2>IF541-D Expert System</h2>
            <h5>Diagnosa Penyakit Jerawat Menggunakan Forward Chaining</h5>
        </div>
        <div class="name-grp">
            <div class="name-card">
